...
export default function PrivacyPolicy({sportstats}) {
  const { t } = useTranslation('common');

  return (
    <Layout >
      <Head>
        <title>Sportstats - Privacy Policy</title>
      </Head>
          ...
          >
             ...
             <Breadcrumb>
              ...
              <BreadcrumbItem isCurrentPage>
                <BreadcrumbLink href='/help/privacy-policy'>Breadcrumb</BreadcrumbLink>
              </BreadcrumbItem>
            </Breadcrumb>
            ...
            <Box>
              ...
              Sportstats may transfer your personal information to third-party service providers or agents who provide services to or on behalf of Sportstats such as hosting, data management and storage services, market analyses, and retention services. Either Sportstats or such third party service provider may use servers for such purposes located in Canada, the United States or another foreign country. The personal information of an Individual may be processed and stored in Canada, the United States or such other foreign country, and the governments, courts or law enforcement or regulatory agencies of that country may be able to obtain disclosure of personal information through the laws of the foreign country.
              Sportstats, our affiliates and our Canadian, US and other service providers may provide your personal information in response to a search warrant or other legally valid inquiry or order, or to an investigative body in the case of a breach of an agreement or contravention of law, or as otherwise required by applicable Canadian, US or other law. We may also disclose personal information where necessary for the establishment, exercise or defence of legal claims.
              We may transfer any information we have about you as an asset in connection with a merger or sale (including transfers made as part of insolvency or bankruptcy proceedings) involving all or part of Sportstats or as part of a corporate reorganization or stock sale or other change in corporate control.
